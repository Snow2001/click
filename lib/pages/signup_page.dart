  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          SizedBox(height: 80,),
          Text('Ro`yxatdan o`tish', style: TextStyle(fontSize: 30, color: Colors.white, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
          SizedBox(height: 40,),
          Text('Telefon raqamingizni kiriting', style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
          Padding(
          ...
          Container(
            ...
            child: Center(
              child: Text('Davom etish', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),),
            ),
          )
        ],
      )
