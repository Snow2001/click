...
class Signupru_page extends StatefulWidget {
  const Signupru_page({Key? key}) : super(key: key);
  static final String id = 'signupru_page';
  @override
  State<Signupru_page> createState() => _Signupru_pageState();
}

class _Signupru_pageState extends State<Signupru_page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(
          ...
          children: [
            SizedBox(height: 80,),
            Text('Постановка на учет', style: TextStyle(fontSize: 30, color: Colors.white, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
            SizedBox(height: 40,),
            Text('Введите свой номер телефона', style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold), textAlign: TextAlign.center,),
            Padding(
            ...
            Container(
              ...
              child: Center(
                child: Text('Продолжить', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20),),
              ),
            )
          ],
        )
